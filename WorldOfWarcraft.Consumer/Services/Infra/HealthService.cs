...
namespace WorldOfWarcraft.Consumer.Services.Infra
{
    /// <summary>
    ...
    /// </param>
    public class HealthService(WorldOfWarcraftDbContext context) : HealthService<WorldOfWarcraftDbContext>(context)
    {
    }
}
