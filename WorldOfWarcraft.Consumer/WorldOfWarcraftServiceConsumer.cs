...
namespace WorldOfWarcraft.Consumer
{
    ...
    public class WorldOfWarcraftServiceConsumer(IOptions<RabbitMQSettings> otps, TableRouter tableRouter, ILogger logger) : BasicServiceConsumer(otps, tableRouter, logger)
    {
        /// <summary>
