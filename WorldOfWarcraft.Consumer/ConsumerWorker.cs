...
namespace WorldOfWarcraft.Consumer
{
    ...
    /// <remarks>
    /// <para>
    /// This worker wraps a <see cref="WorldOfWarcraftServiceConsumer"/> and executes its
    /// <see cref="WorldOfWarcraftServiceConsumer.StartListeningAsync(CancellationToken)"/> method
    ...
    public class ConsumerWorker(IServiceScopeFactory scopeFactory, ILogger logger) : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken ct)
        {
            ...
            var consumer = scope.ServiceProvider.GetRequiredService<WorldOfWarcraftServiceConsumer>();
